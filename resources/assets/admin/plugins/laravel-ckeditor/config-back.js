...
CKEDITOR.editorConfig = function( config ) {
	...
	// 	{ name: 'others' },
	// 	{ name: 'morestuff', groups: ['NumberedList', 'BulletedList'] },
	// 	'/',
...
config.toolbar = [
	...
	{ name: 'iwebtoolbar', items: [ 'Purple', 'Curly' ] }
];
