...
<!--<link rel="icon" href="" />-->
<title>Custom Image Uploader</title>
...
<link href="<?php echo $_GET['ajaxurl'];?>/resources/assets/imageupload/css/photoswipe.css" rel="stylesheet">
<link href="<?php echo $_GET['ajaxurl'];?>/resources/assets/imageupload/css/default-skin/default-skin.css" rel="stylesheet">
<style type="text/css">
#divLargerImage
{
    display: none;
...
<div class="wrapper"> 
    ...
    <div class="header bg-light border-bottom d-flex align-items-center">
        <div class="mr-auto btn-wrapper-head"> 
            ...
            <a href="javascript:void(0);" class="btn btn-primary d-none d-md-inline-block edit" title="Edit"> <i class="fas fa-pen"></i> <span class="btn-text">Edit</span> </a> 
        ...
        <div class="ml-auto">
            <div class="form-inline">
                <input type="text" class="form-control searchImage custom-control d-inline m-r-10" placeholder="Filter | Search" value="" data-toggle="tooltip" title="Click Button for Search">
                <a href="javascript:void(0);" class="btn btn-primary btn-round m-r-10 searchWithBtn"><i class="fas fa-search"></i></a>                
                <a href="javascript:void(0);" class="btn btn-primary btn-round btn-right-side-nav"><i class="fas fa-cog"></i></a> </div>
        </div>
    </div>
    <!-- Header Ends Here --> 
    <!-- Main Section -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Folders</h4>
                </div>
                <!-- Modal Body -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <button class="btn btn-primary save_file m-r-10" >Save</button>
    ...
    <div class="modal fade" id="modalEditImage" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <button class="btn btn-primary save_crop m-r-10" id="save_thumb">Save</button>
                        <button class="btn btn-danger cancel_crop" >Cancel</button>
                    </div>
    ...
    <div class="modal fade" id="modalDeleteImage" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close"><img src="{{url('/resources/assets/admin')}}/images/btn-close.png" title="" alt=""></button>
                <!-- Modal Header -->
                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
                        <button class="btn btn-primary deleteFile m-r-10" >Delete</button>
                        <button class="btn btn-danger cancelDeleteFile" >Cancel</button>
                    </div>
    ...
    <div class="img-crop" style="display: none;">
        ...
        <form name="thumbnail" id="cropimage" method="post">
    ...
    <div style="display: none;">
        <form id="file_upload" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="ajaxurl" id="ajaxurl" value="<?php echo $_GET['ajaxurl'];?>">
            <input type="hidden" name="path" id="path" value="" class="filePath">
...
<script src="<?php echo $_GET['ajaxurl'];?>/resources/assets/imageupload/js/photoswipe.js"></script>
<script src="<?php echo $_GET['ajaxurl'];?>/resources/assets/imageupload/js/photoswipe-ui-default.js"></script>
