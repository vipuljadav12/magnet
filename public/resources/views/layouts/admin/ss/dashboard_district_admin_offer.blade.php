            ...
            <div class="col-12 col-lg-6 mb-20">
                <div class="card shadow h-100 mb-0">
                    ...
                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                        ...
                        <div class="custom-legends" id="js-legend1"><ul class="0-legend"><li><span style="background-color:#4b78b8"></span>Available Seats</li><li><span style="background-color:#00ca70"></span>Offered and Accepted</li><li><span style="background-color:#ffbf00"></span>Declined / Waitlisted for other</li></ul></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-6 mb-20">
...
<script type="text/javascript">
    ...
    //    }]
        datasets: [{
            ...
            label: 'Declined / Waitlisted for other',
            backgroundColor: '#ffbf00',
            borderColor: '#ffbf00',
            fill: false,
            data: [{{implode(",", $arr['declineArr'])}}],
            borderWidth: 2
    //    },{
    //        label: 'Offered and Declined',
    ...
    document.getElementById("change_program1").onchange = function () {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var declineArr = $.map(response.declineArr, function(value, index) {
                    return [value];
                });
