...
function getPowerSchoolRecords($type, $accessTokenKey, $url, $sdata) {
    ...
    switch ($type) {
        case 'enrolled_state_id_students':
            $queryName = 'org.magnet_hcs.enrolled_state_id_students.hs_enrolled_state_id_students';
        break;
        case 'schools':
        ...
        break;
        case 'gen':
            $queryName = 'org.magnet_hcs.gen.hs_gen';
        break;
        case 'cc':
    ...
    if ($type == 'enrolled_state_id_students') {
...
*/
        ...
        if (isset($jsonData['record'])) {
            ...
            foreach ($jsonData['record'] as $item) {
                ...
                $academic_years = array_unique(["2022", "2023"]);
                $academic_year_grades = array_unique(["F1 Grade", "Q1 Grade", "Q2 Grade"]);
