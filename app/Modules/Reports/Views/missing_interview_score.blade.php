...
@section('title')
	Missing Interview Score Report
@endsection
@section('content')
<style type="text/css">
    .alert1 {
...
.dt-buttons {position: absolute !important; padding-top: 5px !important;}
    ...
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            <div class="page-title mt-5 mb-5">Missing Interview Score Report</div></div>
    </div>
    <div class="card shadow">
...
@section('scripts')
	...
	<script type="text/javascript">
        ...
        {
            $("#wrapperloading").show();
            var  url = "{{url('admin/Reports/missing/')}}/"+$("#enrollment_option").val() + "/interview_score/response";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#wrapperloading").hide();
                    var dtbl_submission_list = $("#tbl_interview_score").DataTable(
                        {
                            "aaSorting": [],
                            dom: 'Bfrtip',
                            buttons: [
        ...
        function saveScore(id)
        {
            ...
            if (!$.isEmptyObject(data) && valid == true) { 
                ...
                $.ajax({
                    url : "{{url('/admin/Reports/missing/interview_score/save/')}}/"+id,
                    type: "POST",
                    data : {
                        '_token': "{{csrf_token()}}",
                        data: data
