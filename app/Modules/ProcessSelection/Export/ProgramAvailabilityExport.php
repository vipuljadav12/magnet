...
class ProgramAvailabilityExport implements FromView, ShouldAutoSize, WithEvents
{
    protected $data;
    ...
    public function view(): View
    {
        ...
        return view('ProcessSelection::export.program_availability_report', compact('data'));
    }
    ...
    public function registerEvents(): array
    {
    	return [
    		AfterSheet::class    => function(AfterSheet $event) {
                ...
                // dd($to);
                $sheet->getStyle('A1:'.$to.'2')->applyFromArray($styleArray);
