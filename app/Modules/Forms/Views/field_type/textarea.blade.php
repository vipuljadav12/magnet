<div class="box_control">
	...
	<small></small>
	<textarea class="form-control form-showtext" disabled="disabled" placeholder="{{ getPropertyValue($data->form_field_id,'place_holder_text') }}" rows="{{ getPropertyValue($data->form_field_id,'rows') }}"></textarea>
	{{-- <span class="help_text_view" data-toggle="tooltip" title="{{ getPropertyValue($data->form_field_id,'help_text') }}">
		@if(getPropertyValue($data->form_field_id,'help_text') != "")
			<i class="fas fa-info-circle"></i>
		@endif
