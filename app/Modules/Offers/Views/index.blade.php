            ...
            <div class="card bg-light p-20">
                <div class="">
                  <form method="post" action="{{url('/Offers/store')}}">
                    ...
                    <div class="">IMPORTANT : If you do not accept or decline online by {{getDateTimeFormat($last_online_date)}} or by emailing <a href="magnet@hsv-k12.org">magnet@hsv-k12.org</a> by {{getDateTimeFormat($last_offline_date)}}, your Magnet offer will automatically be DECLINED.</div>
                  </form>
                </div>
            </div>
        </div>
