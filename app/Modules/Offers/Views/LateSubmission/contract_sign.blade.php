            ...
            <div class="p-20">
                ...
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5 mb-10">SELECTED SCHOOL : <strong>{{$data['program_name']}}</strong></div>
                    </div>
                    ...
                    <div class="text-justify">
		                ...
		                <div class="col-12  mb-10">Parent Signature : {{$data['contract_name']}}
        		        <span class="col-12 mb-10 text-lg-right">Date : <strong>{{date("M d, Y")}}</strong></span></div>
