...
@section('title') Create File @stop
...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5"> Create Front Page Link </div>
        <div class="">
...
<form action="{{url('/admin/Files/store')}}" method="post" id="file-add" name="file-add" enctype= "multipart/form-data">
    {{csrf_field()}}
    <div class="card shadow">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 align-self-center">Front Page Link Name : </div>
                <div class="col-md-4">
                    <input type="text" class="form-control" value="{{old('link_title')}}" name="link_title">
                </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4">
                    <select class="form-control custom-select" name="link_type" id="link_type" onchange="showFileText()">
                        <option value="file" @if(old('link_type')=="file") selected @endif>File Attachment</option>
                        <option value="text" @if(old('link_type')=="text") selected @endif>Editable Text Box</option>
                        <option value="link" @if(old('link_type')=="link") selected @endif>Hyperlink to new page</option>
                    </select>
                </div>
            </div>
            <div class="row mt-2" id="file" 
                @if(old('link_type'))
                    ...
                    @endif
                @endif>
                <div class="col-md-3 align-self-center">File Name : </div>
                <div class="col-md-4">
            ...
            <div class="row mt-2" id="text" @if(old('link_type')!="text") style="display: none" @endif>
                ...
                <div class="col-md-9">
                    <textarea class="form-control editor" name="popup_text" id="popup_text">{{ old('popup_text') ?? ''}}</textarea>
            ...
            <div class="row mt-2" id="link" @if(old('link_type')!="link") style="display: none" @endif>
                ...
                <div class="col-md-4">
                    <input class="form-control" name="link_url" id="link_url" value="{{ old('link_url') ?? ''}}">
                </div>
                <div class="col-md-7"></div>
                <div class="row col-md-12 offset-1">
    ...
    <div class="box content-header-floating" id="listFoot">
        <div class="row">
            <div class="col-lg-12 text-right hidden-xs float-right">
                ...
                <button type="submit" class="btn btn-success btn-xs" name="save_exit" value="save_edit" title="Save & E"><i class="fa fa-save"></i> Save &amp; Exit</button>
...
<script type="text/javascript">
    ...
    var old_link_type = "{{old('link_type')}}";
    var select_option = "";
