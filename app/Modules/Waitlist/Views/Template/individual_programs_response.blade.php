    <form action="{{url('/admin/Waitlist/Individual/store')}}" method="post" id="process_selection">
             {{csrf_field()}}
    ...
    <div class="table-responsive">
       ...
       <table class="table m-0" id="tbl_population_changes">
        ...
        <div id="waitingprograms">
        </div>
    </div>

    <div class="form-group mt-20">
        <label for="">Last day and time to accept ONLINE</label>
        <div class=""><input class="form-control datetimepicker" name="last_date_waitlist_online_acceptance" id="last_date_waitlist_online_acceptance" value="{{$last_date_online}}" data-date-format="mm/dd/yyyy hh:ii"></div>
    </div>
    <div class="form-group">
        <label for="">Last day and time to accept OFFLINE</label>
        <div class=""><input class="form-control datetimepicker" name="last_date_waitlist_offline_acceptance" id="last_date_waitlist_offline_acceptance" value="{{$last_date_offline}}" data-date-format="mm/dd/yyyy hh:ii"></div>
    </div>
