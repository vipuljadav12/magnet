...
@section('title')
    Process Waitlist | {{ config('app.name', 'LeanFrogMagnet') }}
@endsection
@section('content')
    <style type="text/css">
        .buttons-excel {
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item"><a class="nav-link" id="preview04-tab" data-toggle="tab" href="#preview04" role="tab"
                aria-controls="preview04" aria-selected="true">Program Max Percent Swing</a></li>
        @if ($displayother > 0)
            <li class="nav-item"><a class="nav-link"
                    href="{{ url('/admin/Waitlist/Population/' . $application_id) }}">Population Changes</a></li>
            <li class="nav-item"><a class="nav-link"
                    href="{{ url('/admin/Waitlist/Submission/Result/' . $application_id) }}">Submission Results</a></li>
        @endif
    </ul>
    <div class="tab-content bordered" id="myTabContent">
        ...
        <div class="tab-pane fade show" id="preview04" role="tabpanel" aria-labelledby="preview04-tab">
            @include('Waitlist::Template.program_max')
        </div>
    </div>
@endsection
@section('scripts')
