...
namespace App\Modules\LateSubmission\Export;

use Maatwebsite\Excel\Concerns\{Exportable,WithEvents,FromView,ShouldAutoSize};
use Maatwebsite\Excel\Events\AfterSheet;
use Illuminate\Contracts\View\View;

class LateSubmissionProcessingExport implements FromView, ShouldAutoSize, WithEvents
{
    protected $data;
    ...
    {
        $data = $this->data;
        return view('LateSubmission::export.export_processing', compact('data'));
    }
