                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row flex-wrap">
                                            @if(isset($district->desegregation_compliance)&&$district->desegregation_compliance=='Yes')
                                                ...
                                                <div class="custom-control custom-radio"><input type="radio" name="selection_method"value="Racial Composition" class="custom-control-input selection_method" id="table27" {{$program->selection_method=='Racial Composition'?'checked':''}}>
                                                    <label for="table27" class="custom-control-label">Racial Composition</label></div>
                                            </div>
                                            @endif
                                            <div class="col-12 col-sm-4">
                                                <div class="custom-control custom-radio"><input type="radio" name="selection_method" value="Home Zone Placement" class="custom-control-input selection_method" id="table23" {{$program->selection_method=='Home Zone Placement'?'checked':''}}>
                                                    <label for="table23" class="custom-control-label">Home Zone Placement</label></div>
                                            </div>
                                            <div class="col-12 col-sm-4">
                                                <div class="custom-control custom-radio"><input type="radio" name="selection_method" value="Lottery Number Only" class="custom-control-input selection_method" id="table24" {{$program->selection_method=='Lottery Number Only'?'checked':''}}>
