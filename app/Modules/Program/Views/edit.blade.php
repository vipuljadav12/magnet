...
@section('title')Edit Program  | {{config('app.name', 'LeanFrogMagnet')}}  @endsection
@section('styles')
                        ...
                        <div class="card-body" style="min-height: 250px !important">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                 ...
                                 <div class="col-12 col-lg-6">
                                    <div class="card p-3">
                                        <input type="hidden" name="feeder_data" value="{{($program->feeder_data ?? '')}}">
                                        ...
                                        <div class="form-group @if($feeder_priority_count == 0) d-none @endif">
                                            ...
                                            <div class="col-md-12">
                                                <select class="custom-sel2" id="feeder_field" {{-- name="feeder_field" --}}>
                                                    <option value="">Choose an Option</option>
                                        ...
                                        <div class="form-group @if($feeder_priority_count == 0) d-none @endif">
                                            ...
                                            <div id="feeder_schools" class="col-md-12">
                                                ...
                                                <select class="custom-sel2" id="select_feeder_priorities" {{-- name="feeder_priorities[]" --}} multiple="">
                                                    {{-- <option value="">Choose an Option</option> --}}
                                                    @foreach($schools as $key=>$value)
                                                        @if($value->name != '')
                                                            <option value="{{trim($value->name)}}">{{$value->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div id="upload_programs" class="col-md-12 d-none">
                                                ...
                                                <select class="custom-sel2" id="select_upload_program_check" {{-- name="upload_program_check[]" --}} multiple="">
                                                    {{-- <option value="">Choose an Option</option> --}}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var db_feeder_field_ary = '{!! (old('feeder_data') ?? $program->feeder_data) !!}';
