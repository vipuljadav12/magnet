    ...
    <div class="tab-content bordered" id="myTab2Content">
                        ...
                        @if($lang->default != 'Y')
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class=""><input type="text" class="form-control" name="application_name_{{$lang->language_code}}" value="{{ $lang_data->{$lang->language_code} ?? $application->application_name}}">
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select class="form-control custom-select" name="fetch_grades_cdi" id="fetch_grades_cdi">
                                    <option value="now" @if($application->fetch_grades_cdi == "now") selected="" @endif>Immediate After Submission</option>
                                    <option value="later" @if($application->fetch_grades_cdi == "later") selected="" @endif>At End of Application Period</option>
                                </select>
                            </div>
                            @if($errors->first('submission_type'))
                                <div class="mb-1 text-danger">
                                        ...
                                        @if($application->form_id == $program['parent_submission_form'])
                                            <div class="formid_{{$program['parent_submission_form']}}">
                                                <div class="custom-control custom-checkbox custom-control-inline">
                                                    <input {{$disabled}} type="checkbox" id="{{$program['id']}}{{$grade['id']}}" name="program_grade_id[]" class="custom-control-input" value="{{$program['id']}},{{$grade['id']}}" {{!empty($appProgTemp) && in_array($program['id'].",".$grade['id'], $appProgTemp)?'checked':''}}>
        ...
        <div class="tab-pane fade" id="active1-screen" role="tabpanel" aria-labelledby="active1-screen-tab">
            @foreach($languages as $lang)
                ...
                <div class="form-group">
                    <label style="width: 100%">Active Screen Title : <a href="{{url('/admin/Application/preview/active_screen/'.$application->id.'/'.$lang->language_code)}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_title[]" value="{{$config_arr[$lang->language_code]['active_screen_title'] ?? ''}}">
                    </div>
                </div>
                <div class="form-group">
                    <label>Active Screen Subject : </label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_subject[]" value="{{$config_arr[$lang->language_code]['active_screen_subject'] ?? ''}}">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="active-email" role="tabpanel" aria-labelledby="active-email-tab">
            @foreach($languages as $lang)
                ...
                <div class="form-group">
                    <label style="width: 100%">Email Subject : <a href="{{url('/admin/Application/preview/active_email/'.$application->id.'/'.$lang->language_code)}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" name="active_email_subject[]" class="form-control" value="{{ $config_arr[$lang->language_code]['active_email_subject'] ?? '' }}">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="active1-email" role="tabpanel" aria-labelledby="active1-email-tab">
            @foreach($languages as $lang)
                ...
                <div class="form-group">
                    <label style="width: 100%">Pending Screen Title : <a href="{{url('/admin/Application/preview/pending_screen/'.$application->id.'/'.$lang->language_code)}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_screen_title[]" value="{{ $config_arr[$lang->language_code]['pending_screen_title']  ?? '' }}">
                    </div>
                </div>
                <div class="form-group">
                    <label>Pending Screen Subject : </label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_screen_subject[]" value="{{ $config_arr[$lang->language_code]['pending_screen_subject']  ?? '' }}">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="active2-email" role="tabpanel" aria-labelledby="active2-email-tab">
            @foreach($languages as $lang)
                ...
                <div class="form-group">
                    <label style="width: 100%">Email Subject : <a href="{{url('/admin/Application/preview/pending_email/'.$application->id.'/'.$lang->language_code)}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>

                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_email_subject[]" value="{{ $config_arr[$lang->language_code]['pending_email_subject'] ?? '' }}">
                    </div>
                </div>
                <div class="form-group">
