...
@section('content')
    ...
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class=""><a class=" btn btn-secondary btn-sm" href="{{ url('admin/GiftedStudents') }}">Go Back</a></div>
        </div>
    </div>
    <div class="tab-content bordered" id="myTabContent">
        <div class="content-wrapper-in" id="importgiftedstudents">
            ...
            <form id="" method="post" action="{{url('admin/GiftedStudents/import/save')}}" enctype="multipart/form-data" novalidate="novalidate">
                {{csrf_field()}}   
                <div class="card shadow">
