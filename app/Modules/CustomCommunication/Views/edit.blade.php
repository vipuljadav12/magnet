                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <select class="form-control custom-select" id="submission_status" name="submission_status">
                                            ...
                                            @endforeach
                                              <option value="Missing Recommendations" @if($data->submission_status == "Missing Recommendations") selected="" @endif>Missing Recommendations</option>

                                            <option value="Missing Writing Samples" @if($data->submission_status == "Missing Writing Samples") selected="" @endif>Missing Writing Samples</option>
