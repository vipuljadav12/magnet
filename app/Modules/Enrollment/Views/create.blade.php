...
@section('content')
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class=""><a href="{{ url('admin/Enrollment') }}" class="btn btn-sm btn-secondary" title="Go Back">Go
                    Back</a></div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="school_year" value="{{ old('school_year') }}" type="text" maxlength="10"
                                    class="form-control">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="confirmation_style" value="{{ old('confirmation_style') }}" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select name="import_grades_by" class="form-control custom-select">
                                    ...
                                    <option value="submission_date" @if (old('import_grades_by') == 'submission_date') selected @endif>
                                        Submission Date
                                    </option>
                                </select>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="begning_date" value="{{ old('begning_date') }}" class="form-control"
                                    id="begning_date">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <label for="">Ending Date (last day of open enrollment period ending at 11:59
                                PM)*</label>
                            <div class="">
                                <input name="ending_date" value="{{ old('ending_date') }}" class="form-control"
                                    id="ending_date">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="perk_birthday_cut_off" value="{{ old('perk_birthday_cut_off') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="kindergarten_birthday_cut_off"
                                    value="{{ old('kindergarten_birthday_cut_off') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="first_grade_birthday_cut_off"
                                    value="{{ old('first_grade_birthday_cut_off') }}" class="form-control"
        ...
        <div class="box content-header-floating" id="listFoot">
            <div class="row">
                <div class="col-lg-12 text-right hidden-xs float-right">
                    ...
                    <a class="btn btn-danger btn-xs" href="{{ url('/admin/Enrollment') }}" title="Cancel"><i
