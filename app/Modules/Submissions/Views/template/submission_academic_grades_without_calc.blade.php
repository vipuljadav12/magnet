...
@endphp
@php 
    $tmpdata = getSubmissionGradeData($submission->id);
@endphp
                    ...
                    <tbody>
                        @if(!empty($tmpdata))
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" class="form-control" name="courseTypeID[{{$ekey}}]" maxlength="5" value="{{$evalue['courseTypeID']}}">
                                </td>
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <select name="courseTypeID[0]" class="form-control custom-select form-control-sm">
                                            <option value="">Chose an Option</option>
                                            <option value="11">English</option>
                                            <option value="30">Science</option>
                                            <option value="35">Social Studies</option>
                                            <option value="39">Reading</option>
                                            <option value="18">Math</option>
                                    </select>
                                </td>
