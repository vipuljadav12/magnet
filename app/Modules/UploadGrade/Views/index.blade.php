...
<head>
    ...
    <link rel="shortcut icon" href="https://magnet-hcs.lfdmypick.com/resources/assets/front/images/favicon2.png"
        type="image/x-icon" />
    <title>HCS</title>
...
<body>
    <header>
        <div class="container">
            <div class="p-10 bg-secondary text-center d-flex justify-content-between align-items-center"
                style="background: #ffffff !important"><a href="javascript:void(0);"
                    class="d-inline-block w-m-150 w-200" title=""><img
                        src="{{ url('/resources/assets/admin/images/login.png') }}" title="" alt=""
                        class="img-fluid"></a><a href="javascript:void(0);" class="d-inline-block w-m-100"
                    title=""><img
                        src="http://magnet-hcs.lfdmypick.com/resources/filebrowser/magnet-hcs/logo/huntsville-city-school_logo.png"
                        title="" alt="" style="max-height: 100px;"></a>
            </div>
        </div>
    </header>
    <main>
            ...
            <div class="mt-20">
                <div class="card bg-light p-20">
                    ...
                    <div class="">
                        ...
                        <form action="{{ url('upload/grade/uploadFiles') }}" method="post"
                            enctype='multipart/form-data' id='frm_gradecdi'>
                            {{ csrf_field() }}
                                ...
                                <div class="col-12 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name='submission_id'
                                            id='submission_id'>
                                        <div><small><em style="font-weight: 600; font-size: 12px;">If your student
                                                    application number e.g. MAGNET-2122-9999 then please enter last 4
                                                    digit e.g. 9999</em></small></div>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-3">
                                    <div class="form-group">
                                        <label for=""><br>Student Date of Birth : </label>
                                        <input type="text" class="form-control" name='dobdatepicker'
                                            id='dobdatepicker' autocomplete="off" placeholder="MM/DD/YYYY">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-auto">
                                    <div class="form-group"><label for="">&nbsp;</label>
                                        <div><br><a href="javascript:void(0);" title=""
                                                class="btn btn-secondary btn-search ml-5 mr-5">Search</a></div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="submit_alert" tabindex="-1" role="dialog" aria-labelledby="submit_alertLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="option1" tabindex="-1" role="dialog" aria-labelledby="option1Label"
        aria-hidden="true">
        <div class="modal-dialog">
    ...
    <div class="modal fade" id="option2" tabindex="-1" role="dialog" aria-labelledby="option2Label"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content border-0 rounded">
                <div class="modal-body p-0">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (jQuery.type(response) == "string") {
                        ...
                        var show_data = '';
                        show_data = '<tr><td>' + response[0].id + '</td><td>' + $('#dobdatepicker')
                            .val() + '</td><td>' + response[0].first_name + ' ' + response[0]
                            .last_name +
                            '</td><td><div class="text-center main-tr"><label for="grade_file_1" class="cls_grade_file btn btn-secondary">Upload</label><i class="fa fa-plus ml-20 grade_upload_plus" aria-hidden="true"></i><input type=file id=grade_file_1 name=grade_file[] class="grade_file"><div class="append_file_name"></div></div></td></tr>';
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.grade_upload_plus', function() {
                ...
                var html = '<tr><td colspan="3"></td><td><div class="text-center"><label for="grade_file_' +
                    count +
                    '" class="cls_grade_file btn btn-secondary">Upload</label><i class="fa fa-plus ml-20 grade_upload_plus" aria-hidden="true"></i><i class="fa fa-minus ml-10 grade_upload_minus" aria-hidden="true"></i><input type="file" id="grade_file_' +
                    count +
                    '" name=grade_file[] class="grade_file"><div class="append_file_name"></div></div></td></tr>';
