                                    ...
                                    <div class="col-md-4 pt-5 pb-5">
                                        <div class="row col-md-12">
                                            ...
                                            <select id="zoned_school" class="form-control col-md-12 display-inline-block">
                                                ...
                                                <?php $__currentLoopData = $zoned_school; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4 pt-5 pb-5">
                                        <div class="row col-md-12">
                                            ...
                                            <select id="grade_level" class="form-control col-md-12 display-inline-block">
                                                ...
                                                <?php $__currentLoopData = $grade_level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4 pt-5 pb-5">
                                        <div class="row col-md-12">
                                            ...
                                            <select id="hear_us" class="form-control col-md-12 display-inline-block">
                                                ...
                                                <?php $__currentLoopData = $hearUsQuestion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        {
            $("#wrapperloading").show();
            var  url = "<?php echo e(url('admin/Reports/missing/')); ?>/magnet_marketing_report/response";

            
            $.ajax({
                type: 'post',
                data: {"program_id": $("#program_id").val(), "grade_level": $("#grade_level").val(), "hear_us": $("#hear_us").val(), "zoned_school": $("#zoned_school").val(), "_token": "<?php echo e(csrf_token()); ?>", "enrollment_id": <?php echo e($enrollment_id); ?>},
                dataType: 'JSON',
                url: url,
