    ...
    <div class="">
            <div class="">
                    ...
                    <ul class="nav nav-tabs" id="myTab1" role="tablist1">
                        <?php $__currentLoopData = $gradeArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(url('admin/Reports/Selection/'.$application_id.'/'.$value)); ?>">Grade <?php echo e($value); ?></a></li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                                            ...
                                            <table class="table table-striped mb-0 w-100" id="datatable">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $final_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($value['next_grade'] == $existGrade): ?>
                                                            <tr>
                                                                ...
                                                                <td class="hiderace"><?php echo e($value['next_grade']); ?></td>
                                                                <td class="">
