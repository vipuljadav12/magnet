<?php $__env->startSection('title'); ?>Process Late Submission | <?php echo e(config('app.name', 'LeanFrogMagnet')); ?> <?php $__env->stopSection(); ?>
    ...
    <div class="card shadow">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <?php if($displayother > 0): ?>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/admin/LateSubmission/Population/'.$application_id)); ?>">Population Changes</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/admin/LateSubmission/Submission/Result/'.$application_id)); ?>">Submission Results</a></li>
            <?php endif; ?>
        </ul>
        <div class="tab-content bordered" id="myTabContent">
            <?php echo $__env->make('LateSubmission::Template.all_availability', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <div class="tab-pane fade show" id="preview04" role="tabpanel" aria-labelledby="preview04-tab">
                <?php echo $__env->make('LateSubmission::Template.program_max', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    	   ...
    	   $('#process_selection').submit(function(event) {
             ...
             else
             {
                 ...
                 var selected = false;
                  ...
                  $("#wrapperloading").show();
    	            $.ajax({
    	                url:'<?php echo e(url('/admin/LateSubmission/Process/Selection/'.$application_id.'/store')); ?>',
    	                type:"POST",
    	                data: $('#process_selection').serialize(),
    	                success:function(response){
    	                   $("#wrapperloading").hide();
                           if($("#process_event").val() != "saveonly")
                                document.location.href = "<?php echo e(url('/admin/LateSubmission/Population/'.$application_id)); ?>";
                            $("#process_event").val("");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/LateSubmission/Views/all_availability_index.blade.php ENDPATH**/ ?>