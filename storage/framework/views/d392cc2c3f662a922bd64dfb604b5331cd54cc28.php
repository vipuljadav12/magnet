...
<style type="text/css">
    ...
    <form class="">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/admin/Waitlist/Population/'.$application_id)); ?>">Population Change</a></li>
        ...
        <div class="tab-content bordered" id="myTabContent">
            <?php echo $__env->make('Waitlist::Template.submissions_result', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </form>    
