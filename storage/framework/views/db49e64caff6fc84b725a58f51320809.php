                ...
                <ul class="nav nav-tabs custom-nav-tabs" id="myTab2">
                            ...
                            <div class="tab-content tab-validate  bordered" id="myTab2Content">
                                <div class="tab-pane fade show active" id="accept-email">
                                     <form class="" action="<?php echo e(url('admin/DistrictConfiguration/saveEditEmail')); ?>" method="POST" onsubmit="return ValidateForm('offer_accepted')">
                                        <?php echo e(csrf_field()); ?>

                                        <div class="form-group col-12">
	                                        <label style="width: 100%">Mail Subject : <a href="<?php echo e(url('/admin/DistrictConfiguration/preview/thanks/email/offer_accepted')); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
	                                        <div class="">
	                                            <input type="text" class="form-control" name="offer_accepted_mail_subject" id="offer_accepted_mail_subject" value="<?php echo e($offer_accepted_mail_subject->value ?? ''); ?>">
	                                        </div>
	                                    </div>
                                        <div class="form-group col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor01" name="offer_accepted_mail_body" id="offer_accepted_mail_body">
                                                        <?php echo $offer_accepted_mail_body->value ?? ''; ?>
                                ...
                                <div class="tab-pane fade" id="declined-email">
                                     <form class="" action="<?php echo e(url('admin/DistrictConfiguration/saveEditEmail')); ?>" method="POST" onsubmit="return ValidateForm('offer_declined')">
                                        <?php echo e(csrf_field()); ?>

                                        <div class="form-group col-12">
	                                        <label style="width: 100%">Mail Subject : <a href="<?php echo e(url('/admin/DistrictConfiguration/preview/thanks/email/offer_declined')); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
	                                        <div class="">
	                                            <input type="text" class="form-control" name="offer_declined_mail_subject" id="offer_declined_mail_subject" value="<?php echo e($offer_declined_mail_subject->value ?? ''); ?>">
	                                        </div>
	                                    </div>
                                        <div class="form-group col-12">
                                            <label class="control-label">Mail Body : </label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor02" name="offer_declined_mail_body" id="offer_declined_mail_body">
                                                        <?php echo $offer_declined_mail_body->value ?? ''; ?>
                                ...
                                <div class="tab-pane fade" id="waitlisted-email">
                                      <form class="" action="<?php echo e(url('admin/DistrictConfiguration/saveEditEmail')); ?>" method="POST" onsubmit="return ValidateForm('offer_waitlisted')">
                                        <?php echo e(csrf_field()); ?>

                                        <div class="form-group col-12">
	                                        <label style="width: 100%">Mail Subject : <a href="<?php echo e(url('/admin/DistrictConfiguration/preview/thanks/email/offer_waitlisted')); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
	                                        <div class="">
	                                            <input type="text" class="form-control" name="offer_waitlisted_mail_subject" id="offer_waitlisted_mail_subject" value="<?php echo e($offer_waitlisted_mail_subject->value ?? ''); ?>">
	                                        </div>
	                                    </div>
                                        <div class="form-group col-12">
                                            <label class="control-label">Mail Body : </label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor03" name="offer_waitlisted_mail_body" id="offer_waitlisted_mail_body">
                                                        <?php echo $offer_waitlisted_mail_body->value ?? ''; ?>
                                ...
                                <div class="tab-pane fade  d-none" id="contract-signed-email">
                                      <form class="" action="<?php echo e(url('admin/DistrictConfiguration/saveEditEmail')); ?>" method="POST" onsubmit="return ValidateForm('contract_signed')">
                                        <?php echo e(csrf_field()); ?>

                                        <div class="form-group col-12">
                                            <label style="width: 100%">Mail Subject : <a href="<?php echo e(url('/admin/DistrictConfiguration/preview/thanks/email/contract_signed')); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                                            <div class="">
                                                <input type="text" class="form-control" name="contract_signed_mail_subject" id="contract_signed_mail_subject" value="<?php echo e($contract_signed_mail_subject->value ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group col-12">
                                            <label class="control-label">Mail Body : </label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor04" name="contract_signed_mail_body" id="contract_signed_mail_body">
                                                        <?php echo $contract_signed_mail_body->value ?? ''; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/DistrictConfiguration/Views/edit_thanks_emails.blade.php ENDPATH**/ ?>