...
<?php $__env->startSection('title'); ?>Add Priority <?php $__env->stopSection(); ?>
...
<form id="priority-add" method="post" action="<?php echo e(url('admin/Priority/store')); ?>">
    ...
    <div class="card shadow">
        <div class="card-header">
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" maxlength="30" class="form-control" value="">
                        ...
                        <table class="table table-striped mb-0" id="priority">
                            ...
                            <tbody class="priority-list">
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" class="form-control description" name="description[<?php echo e($i); ?>]" maxlength="50" value="Priority 1">
                                    ...
                                    <?php $__currentLoopData = $dynamic_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" name="<?php echo e($value[1]); ?>[<?php echo e($i); ?>]" id="<?php echo e($value[1]); ?>_<?php echo e($i); ?>">
                                                <label for="<?php echo e($value[1]); ?>_<?php echo e($i); ?>" class="custom-control-label"></label>
                                            </div>
                                        </td>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/Priority/Views/create.blade.php ENDPATH**/ ?>