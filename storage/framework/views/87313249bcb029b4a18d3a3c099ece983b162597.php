<?php $__env->startSection('title'); ?>Configuration | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?> <?php $__env->stopSection(); ?>
    ...
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="">
                ...
                <a href="<?php echo e(url('admin/Configuration/create')); ?>" class="btn btn-sm btn-secondary d-none" title="Add Text">Add Text</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                    ...
                    <?php $__currentLoopData = $configurations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$configuration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           ...
                           <!-- <td class="text-center">
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(url('admin/Configuration/edit',$configuration->id)); ?>" class="font-18 ml-5 mr-5" title="Edit"><i class="far fa-edit"></i></a>
                                <a href="javascript:void(0)" onclick="deletefunction(<?php echo e($configuration->id); ?>)" class="font-18 ml-5 mr-5 text-danger d-none" title="Delete"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
