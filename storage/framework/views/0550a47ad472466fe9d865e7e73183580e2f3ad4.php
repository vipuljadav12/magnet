...
Edit Form | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?>
     ...
     <form action="<?php echo e(url('admin/Form/update/'.$page_id.'/'.$form->id)); ?>" method="post" name="edit_form">
        ...
        <div class="tab-content bordered" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="create" role="tabpanel" aria-labelledby="create-tab">
                ...
                <?php echo $__env->make("Form::formbuilder", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script type="text/javascript">
    ...
    <?php echo $__env->make("Form::builderjs", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
