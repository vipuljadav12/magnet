<?php $__env->startSection('title'); ?>
    Import Missing Committee Score | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?>
...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5">Import Missing Committee Score</div><div class=""><a class=" btn btn-secondary btn-sm" href="<?php echo e(url('/admin/Reports/missing/'.$enrollment_id.'/committee_score')); ?>">Go Back</a></div>
    </div>
</div>
<div class="">
        ...
        <div class="content-wrapper-in" id="importmissinggrade">
            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="pt-10">
                        <a href="<?php echo e(url('/resources/assets/admin/ImportMissingCommitteeScoreNew.xlsx')); ?>" class="btn btn-secondary">Download Template</a>
                    </div>
                </div>
            </div>

            <form id="frm_mcs_import" method="post" action="<?php echo e(url('admin/Reports/import/missing/committee_score')); ?>" enctype="multipart/form-data" novalidate="novalidate">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 mb-15">
                                ...
                                <?php if($errors->first('imp_file')): ?>
                                    <div class="mb-1 text-danger">
                                        <?php echo e($errors->first('imp_file')); ?>
