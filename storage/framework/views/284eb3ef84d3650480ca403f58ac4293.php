<script type="text/javascript">
    ...
    function box_control(obj)
    {
		...
		var page_id = <?php echo e($page_id); ?>;
		// alert(fieldType);
		$.ajax({
			url: '<?php echo e(url("admin/Form/insertField")); ?>',
			type: 'GET',
			data: {
				type:fieldType,
				field_id:fieldID,
  ...
  //   	var filteredList = list.filter(function (el) {
		...
		// });
    	$.ajax({
			url: '<?php echo e(url("admin/Form/registerSort/")); ?>',
			type: 'POST',
			data:
			{
				_token:"<?php echo e(csrf_token()); ?>",
				data:list,
				form_id:'<?php echo e($form->id); ?>'
			},
			success: function(data) {
    			console.log(data);
			},
    ...
    function getFormContent()
    {
    	...
    	// alert(form_id);
    	$.ajax({
			url: '<?php echo e(url("admin/Form/getFormContent")); ?>',
			type: 'GET',
			data: {
				form_id:form_id,
				page_id:page_id
	...
	$(document).on("click",".removeField",function()
	{
		...
		$.ajax({
			url: '<?php echo e(url("admin/Form/removeField/")); ?>'+"/"+build_id,
			type: 'GET',
			success: function(data) {
    			getFormContent();
			},
	...
	$(document).on("click",".removeMoreOption",function()
	{
		...
		{
			$.ajax({
				url: '<?php echo e(url("admin/Form/removeOption/")); ?>'+"/"+content_id,
				type: 'GET',
				success: function(data) {
	...
	$(document).on("click",".form-group-input",function()
	{
		...
		$.ajax({
			url: '<?php echo e(url("admin/Form/fieldEditor/")); ?>'+"/"+build_id,
			type: 'GET',
			success: function(data) {
    			// getFormContent();
	...
	$(document).on("blur",".editorInput",function()
	{
		...
		var build_id = $(this).attr("build-id");
		$.ajax({
			url: '<?php echo e(url("admin/Form/saveSingle/")); ?>',
			type: 'POST',
			data:
			{
				_token:"<?php echo e(csrf_token()); ?>",
	...
	$(document).on("click",".saveFormCreate",function()
	{
		...
		var form_id = $(document).find("#form_id").val();
		$.ajax({
		  url: '<?php echo e(url("admin/Form/saveBuild")); ?>',
		  type: 'post',
		  data: {
		 	_token:"<?php echo e(csrf_token()); ?>",
	...
	$(document).on("keyup focusout",".FormPageTitle",function()
	{
		...
		$.ajax(
		{
			url: '<?php echo e(url("admin/Form/changeTitle/")); ?>'+"/"+form_id+"/"+page_id,
			type: 'GET',
			data:{
...
</script><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/Form/Views/builderjs.blade.php ENDPATH**/ ?>