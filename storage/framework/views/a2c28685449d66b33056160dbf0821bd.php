...
<?php $__env->startSection('title'); ?>Waitlist Process Selection | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?> <?php $__env->stopSection(); ?>
...
<script type="text/javascript">
    ...
    $("#form_field").change(function()
    {
        if($(this).val() != "")
        {
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('admin/Waitlist/Process/Selection/validate/application/')); ?>/'+$(this).val(),
                type:"GET",
    ...
    $("#selectform_settings").click(function()
    {
        ...
        <?php if($selection != ""): ?>
            document.location.href = "<?php echo e(url('/admin/Waitlist/Admin/Selection/')); ?>/"+$("#form_field").val();
        <?php else: ?>
            document.location.href = "<?php echo e(url('/admin/Waitlist/Process/Selection/')); ?>/"+$("#form_field").val();
        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/Waitlist/Views/application_index.blade.php ENDPATH**/ ?>