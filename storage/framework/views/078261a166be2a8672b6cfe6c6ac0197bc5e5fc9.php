            ...
            <div class="row">
                <div class="col-12 col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled value="<?php echo e($enrollment_racial->black); ?>" type="text" maxlength="10" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled value="<?php echo e($enrollment_racial->white); ?>" type="text" maxlength="10" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled value="<?php echo e($enrollment_racial->other); ?>" type="text" maxlength="10" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled value="<?php echo e($enrollment_racial->swing); ?>" type="text" maxlength="10" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
