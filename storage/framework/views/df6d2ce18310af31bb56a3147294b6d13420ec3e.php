  ...
  <div class="mt-20">
    <div class="card bg-light p-20">
      ...
      <?php else: ?>
        ...
        <div class="text-left">
          <ul>
              <li>You will have <strong><?php echo e($extra); ?></strong> to complete the essay.  The timer begins once you access the writing prompt.  Once the <strong><?php echo e($extra); ?></strong> ends the essay will automatically be submitted.</li>
      ...
      <div class="p-20 mt-20 mb-10">
        <div class="box-0">
          <div class="col-12 col-md-6 col-xl-12 text-center">
            <form method="post" action="<?php echo e(url('/WritingPrompt/exam')); ?>">
