<?php $__env->startSection('title'); ?>Late Submission Preliminary Selection | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?> <?php $__env->stopSection(); ?>
        ...
        <div class="card-body">
            <div class="col-12">
                <div class="form-group row">
                    ...
                    <label for="" class="page-title control-label col-4 font-18"><?php echo e($submissions); ?></label>
                </div>

                <div class="form-group row">
                    <label for="" class="page-title control-label col-4 font-18">Submissions that have a Preliminary Score:  </label>
                    <label for="" class="page-title control-label col-4 font-18"><?php echo e($exist_count); ?></label>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
         $('#process_preliminary').click(function(event) {
            ...
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('/admin/LateSubmission/Preliminary/Processing/calculate')); ?>',
                type:"POST",
                data: {"_token": "<?php echo e(csrf_token()); ?>", "thresold_val": $("#thresold_val").val()},
         ...
         $('#commit_preliminary').click(function(event) {
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('/admin/LateSubmission/Preliminary/Processing/commit')); ?>',
                type:"POST",
                data: {"_token": "<?php echo e(csrf_token()); ?>", "thresold_val": $("#thresold_val").val()},
                success:function(response){
                    $("#wrapperloading").hide();
         ...
         $('#rollback_preliminary').click(function(event) {
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('/admin/LateSubmission/Preliminary/Processing/rollback')); ?>',
                type:"POST",
                data: {"_token": "<?php echo e(csrf_token()); ?>", "thresold_val": $("#thresold_val").val()},
                success:function(response){
                    $("#wrapperloading").hide();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/LateSubmission/Views/Preliminary/index.blade.php ENDPATH**/ ?>