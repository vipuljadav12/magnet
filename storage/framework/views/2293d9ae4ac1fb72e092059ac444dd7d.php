...
<?php $__env->startSection('title'); ?>Edit Program  | <?php echo e(config('app.name', 'LeanFrogMagnet')); ?>  <?php $__env->stopSection(); ?>
    ...
    <form action="<?php echo e(url('admin/Program/update',$program->id)); ?>" method="post" name="edit_district" enctype= "multipart/form-data">
        ...
        <div class="tab-content bordered" id="myTabContent">
            ...
            <div class="tab-pane fade" id="eligibility" role="tabpanel" aria-labelledby="eligibility-tab">
                <?php echo $__env->make("Program::Template.eligibility_edit", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            <div class="tab-pane fade" id="process" role="tabpanel" aria-labelledby="process-tab">
                <?php echo $__env->make("Program::Template.selection", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>

            <div class="tab-pane fade" id="exception" role="tabpanel" aria-labelledby="exception-tab">
                <?php echo $__env->make("Program::Template.exception", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/Program/Views/edit.blade.php ENDPATH**/ ?>