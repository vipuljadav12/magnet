            ...
            <div class="box-2-1" style="">
                ...
                <div class="card" id="infodiv">
                    <div class="card-header">Step <?php echo e($page_id); ?> - <?php echo e(getFormPageTitle($data[0]->form_id, $page_id)); ?></div>
                     <div class="card-body">
                        <?php echo $__env->make("layouts.front.form_fields", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\resources\views/layouts/front/form_display.blade.php ENDPATH**/ ?>