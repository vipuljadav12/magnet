    ...
    <div class="content-wrapper-in">
        ...
        <div class="card shadow">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                ...
                <div class=""><a href="<?php echo e(url('')); ?>/admin/Availability/import"
                        class="text-white btn btn-sm btn-success" title="">Import Availability</a></div>
    ...
    <script type="text/javascript">
        ...
        function matchWithTotal() {
            $(document).find(".whiteSeat").each(function() {
                ...
                var notSpecifiedSeat = $(document).find("input[name='grades[" + grade + "][not_specified_seats]']")
                    .val();

                var value = parseInt(whiteSeat || 0) + parseInt(blackSeat || 0) + parseInt(otherSeat || 0) +
                    parseInt(notSpecifiedSeat || 0);
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(key, program) {
                        if (selected_program == program.id) {
                            p_flag = false;
                            $('#programs').append(new Option(program.name, program.id, true,
                                true));
                        } else {
