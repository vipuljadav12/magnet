...
.dt-buttons {position: absolute !important; padding-top: 5px !important;}
    ...
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            <div class="page-title mt-5 mb-5">Missing Academic Score Report</div></div>
    </div>
    <div class="card shadow">
...
<?php $__env->startSection('scripts'); ?>
	...
	<script type="text/javascript">
        ...
        {
            $("#wrapperloading").show();
            var  url = "<?php echo e(url('admin/Reports/missing/'.$enrollment_id.'/')); ?>/academic_score/response";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#wrapperloading").hide();
                    var dtbl_submission_list = $("#tbl_academic_score").DataTable(
                        {
                            "aaSorting": [],
                            dom: 'Bfrtip',
                            buttons: [
        ...
        function saveScore(id)
        {
            ...
            if (!$.isEmptyObject(data) && valid == true) { 
                ...
                $.ajax({
                    url : "<?php echo e(url('/admin/Reports/missing/academic_score/save/')); ?>/"+id,
                    type: "POST",
                    data : {
                    ...
                    success: function(data)
                    {
                        ...
                        alert("Interview Score updated successfully");
                        if(!zeroInclude)
                        {
                            $("#row"+id).remove();
                        }
