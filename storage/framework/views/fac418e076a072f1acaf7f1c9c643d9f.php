...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
         $('#process_preliminary').click(function(event) {
            ...
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('/admin/Preliminary/Processing/calculate')); ?>',
                type:"POST",
         ...
         $('#commit_preliminary').click(function(event) {
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('/admin/Preliminary/Processing/commit')); ?>',
                type:"POST",
                data: {"_token": "<?php echo e(csrf_token()); ?>", "thresold_val": $("#thresold_val").val()},
                success:function(response){
                    $("#wrapperloading").hide();
         ...
         $('#rollback_preliminary').click(function(event) {
            $("#wrapperloading").show();
            $.ajax({
                url:'<?php echo e(url('/admin/Preliminary/Processing/rollback')); ?>',
                type:"POST",
                data: {"_token": "<?php echo e(csrf_token()); ?>", "thresold_val": $("#thresold_val").val()},
                success:function(response){
                    $("#wrapperloading").hide();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/ProcessSelection/Views/Preliminary/index.blade.php ENDPATH**/ ?>