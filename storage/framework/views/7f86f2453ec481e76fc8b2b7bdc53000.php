...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5">Add Permission</div>
        <div class="">
...
<form id="permissionSubmitForm" method="POST" action="<?php echo e(url('admin/Permission/store')); ?>">
    <?php echo e(csrf_field()); ?>

    <div class="card shadow">
        <div class="card-body">
             <div class="form-group">
                <label for="" class="">Slug Name<span class="ml-2">*</span></label>
                <div class="">
            ...
            <div class="form-group">
                <label for="" class="">Display Name<span class="ml-2">*</span></label>
                <div class="">
            ...
            <div class="form-group">
                <label for="" class="">Module<span class="ml-2">*</span></label>
                <div class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vipuljadav\www\projects\laravel\MagnetHCS\app/Modules/Permission/Views/create.blade.php ENDPATH**/ ?>