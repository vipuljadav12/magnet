    ...
    <div class="tab-content bordered" id="myTab2Content">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($lang->default != 'Y'): ?>
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    <label for="">Application Name <span class="font-16 text-info"><strong>[<?php echo e($lang->language); ?>]</strong></span></label>
                                    <div class=""><input type="text" class="form-control" name="application_name_<?php echo e($lang->language_code); ?>" value="<?php echo e($lang_data->{$lang->language_code} ?? $application->application_name); ?>">
                                    </div>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <select class="form-control custom-select" name="form_id" id="form_id" style="pointer-events: none; background-color: #e9ecef;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select class="form-control custom-select" name="fetch_grades_cdi" id="fetch_grades_cdi">
                                    <option value="now" <?php if($application->fetch_grades_cdi == "now"): ?> selected="" <?php endif; ?>>Immediate After Submission</option>
                                    <option value="later" <?php if($application->fetch_grades_cdi == "later"): ?> selected="" <?php endif; ?>>At End of Application Period</option>
                                </select>
                            </div>
                            <?php if($errors->first('submission_type')): ?>
                                <div class="mb-1 text-danger">
                                        ...
                                        <?php if($application->form_id == $program['parent_submission_form']): ?>
                                            <div class="formid_<?php echo e($program['parent_submission_form']); ?>">
                                                <div class="custom-control custom-checkbox custom-control-inline">
                                                    <input <?php echo e($disabled); ?> type="checkbox" id="<?php echo e($program['id']); ?><?php echo e($grade['id']); ?>" name="program_grade_id[]" class="custom-control-input" value="<?php echo e($program['id']); ?>,<?php echo e($grade['id']); ?>" <?php echo e(!empty($appProgTemp) && in_array($program['id'].",".$grade['id'], $appProgTemp)?'checked':''); ?>>
        ...
        <div class="tab-pane fade" id="active1-screen" role="tabpanel" aria-labelledby="active1-screen-tab">
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group">
                    <label style="width: 100%">Active Screen Title : <a href="<?php echo e(url('/admin/Application/preview/active_screen/'.$application->id.'/'.$lang->language_code)); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_title[]" value="<?php echo e($config_arr[$lang->language_code]['active_screen_title'] ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label>Active Screen Subject : </label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_subject[]" value="<?php echo e($config_arr[$lang->language_code]['active_screen_subject'] ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="active-email" role="tabpanel" aria-labelledby="active-email-tab">
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group">
                    <label style="width: 100%">Email Subject : <a href="<?php echo e(url('/admin/Application/preview/active_email/'.$application->id.'/'.$lang->language_code)); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" name="active_email_subject[]" class="form-control" value="<?php echo e($config_arr[$lang->language_code]['active_email_subject'] ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="active1-email" role="tabpanel" aria-labelledby="active1-email-tab">
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group">
                    <label style="width: 100%">Pending Screen Title : <a href="<?php echo e(url('/admin/Application/preview/pending_screen/'.$application->id.'/'.$lang->language_code)); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_screen_title[]" value="<?php echo e($config_arr[$lang->language_code]['pending_screen_title']  ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label>Pending Screen Subject : </label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_screen_subject[]" value="<?php echo e($config_arr[$lang->language_code]['pending_screen_subject']  ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="active2-email" role="tabpanel" aria-labelledby="active2-email-tab">
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group">
                    <label style="width: 100%">Email Subject : <a href="<?php echo e(url('/admin/Application/preview/pending_email/'.$application->id.'/'.$lang->language_code)); ?>" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>

                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="pending_email_subject[]" value="<?php echo e($config_arr[$lang->language_code]['pending_email_subject'] ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="tab-pane fade" id="cdi-grade-upload" role="tabpanel" aria-labelledby="cdi-grade-upload-tab">
            ...
            <div class="form-group pb-0 mb-0 pt-20">
                ...
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <textarea class="form-control editor" id="grade_cdi_welcome_text_<?php echo e($lang->language_code); ?>" name="grade_cdi_welcome_text[]">
        ...
        <div class="tab-pane fade" id="cdi-grade-confirm" role="tabpanel" aria-labelledby="cdi-grade-confirm-tab">
            ...
            <div class="form-group pb-0 mb-0 pt-20">
                ...
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <textarea class="form-control editor" id="grade_cdi_confirm_text_<?php echo e($lang->language_code); ?>" name="grade_cdi_confirm_text[]">
        ...
        <div class="box content-header-floating" id="listFoot">
            <div class="row">
                <div class="col-lg-12 text-right hidden-xs float-right">
                    ...
                    <?php else: ?>
                        <a href="javascript:void(0)" class="btn btn-warning btn-xs" title="You can not edit application cause current enrollment is expired." style="cursor: not-allowed;"><i class="fa fa-save"></i> Save </a>
                        <a href="javascript:void(0)" class="btn btn-success btn-xs submit" title="You can not edit application cause current enrollment is expired." style="cursor: not-allowed;"><i class="fa fa-save"></i> Save &amp; Exit</a>
                    <?php endif; ?>
