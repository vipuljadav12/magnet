    ...
    <?php if(isset($scoring->type) && ($scoring->type == "DD" || $scoring->type == "GA" || $scoring->type == "YWA")): ?>

            <?php if(isset($submission_data) && $submission_data != ''): ?>
            <form id="store_grades_form" method="post" action="<?php echo e(url('admin/Submissions/update/AcademicGradeCalculation',$submission->id)); ?>">
                <?php echo e(csrf_field()); ?>

                <div class="card shadow">
                    <div class="card-header"><?php echo e($value->eligibility_name); ?></div>
                    <div class="card-body">
                        <?php if($scoring->type == "YWA"): ?>
                            <?php $__currentLoopData = $ywa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yk=>$yv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-group row">
                                    <label class="control-label col-12 col-md-12"><?php echo e($yk); ?> Grade Average : </label>
                                    <div class="col-12 col-md-12">
                                        <input type="text" class="form-control" value="<?php echo e($yv); ?>">
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php elseif($scoring->type == "GA"): ?>
                            <div class="form-group row">
                                <label class="control-label col-12 col-md-12">Grade Average : </label>
                                <div class="col-12 col-md-12">
                                    <input type="text" class="form-control" name="gpa" value="<?php echo e($finalAvg); ?>">
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(isset($scoring->method) && $scoring->method == "NR"): ?>
                            <?php $options = $scoring->NR ?>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-md-12">
                                                <select class="form-control custom-select template-type" name="given_score">
                                                    ...
                                                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($v); ?>" <?php if($v==$academic_score): ?> selected="" <?php endif; ?>><?php echo e($v); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
    ...
    <?php if(isset($scoring->type) && $scoring->type == "CLSG"): ?>
                        <div class="card shadow">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div><?php echo e($value->eligibility_name); ?></div>
                                <?php if($value->override == 'Y'): ?>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-10">Override Grades</div> 
                                        <input id="chk_acd" type="checkbox" class="js-switch js-switch-1 js-switch-xs grade_override" data-size="Small"  <?php echo e($submission->grade_override=='Y'?'checked':''); ?>/>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="card-body d-flex">
                                ...
                                <?php $__currentLoopData = $clsgArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skey=>$svalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-group row mr-10">
                                            <label class="control-label col-12 col-md-12"><?php echo e($subjects[$skey]); ?></label>
                                            <div class="col-12 col-md-12">
                                                <input type="text" class="form-control" value="<?php echo e($svalue); ?>">
                                            </div>
                                        </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
