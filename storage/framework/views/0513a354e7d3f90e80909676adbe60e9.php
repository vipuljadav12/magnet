...
<?php $__env->startSection('content'); ?>
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class=""><a href="<?php echo e(url('admin/Enrollment')); ?>" class="btn btn-sm btn-secondary" title="Go Back">Go
                    Back</a></div>
        </div>
    </div>
    ...
    <form id="add-enrollment" method="post" action="<?php echo e(url('admin/Enrollment/store')); ?>">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="school_year" value="<?php echo e(old('school_year')); ?>" type="text" maxlength="10"
                                    class="form-control">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="confirmation_style" value="<?php echo e(old('confirmation_style')); ?>" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select name="import_grades_by" class="form-control custom-select">
                                    ...
                                    <option value="submission_date" <?php if(old('import_grades_by') == 'submission_date'): ?> selected <?php endif; ?>>
                                        Submission Date
                                    </option>
                                </select>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="begning_date" value="<?php echo e(old('begning_date')); ?>" class="form-control"
                                    id="begning_date">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <label for="">Ending Date (last day of open enrollment period ending at 11:59
                                PM)*</label>
                            <div class="">
                                <input name="ending_date" value="<?php echo e(old('ending_date')); ?>" class="form-control"
                                    id="ending_date">
        ...
        <div class="card shadow">
            <div class="card-header">Application Cut offs<br>
                <small>Applications must be born on or before:</small>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="perk_birthday_cut_off" value="<?php echo e(old('perk_birthday_cut_off')); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="kindergarten_birthday_cut_off"
                                    value="<?php echo e(old('kindergarten_birthday_cut_off')); ?>" class="form-control"
                                    id="kindergarten_birthday_cut_off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input name="first_grade_birthday_cut_off"
                                    value="<?php echo e(old('first_grade_birthday_cut_off')); ?>" class="form-control"
                                    id="first_grade_birthday_cut_off">
        ...
        <div class="box content-header-floating" id="listFoot">
            <div class="row">
                <div class="col-lg-12 text-right hidden-xs float-right">
                    ...
                    <a class="btn btn-danger btn-xs" href="<?php echo e(url('/admin/Enrollment')); ?>" title="Cancel"><i
