<?php $__env->startSection('title'); ?>Process Late Submission | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?> <?php $__env->stopSection(); ?>
  ...
  overflow: auto;
    ...
    <div class="card shadow">
        ...
        <div class="tab-content bordered" id="myTabContent">
            <?php echo $__env->make('LateSubmission::Template.all_availability', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <div class="tab-pane fade show" id="preview04" role="tabpanel" aria-labelledby="preview04-tab">
                <?php echo $__env->make('LateSubmission::Template.program_max', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
